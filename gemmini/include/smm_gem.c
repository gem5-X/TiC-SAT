...
void tiledCompute(size_t seq_len, const uint32_t *input, uint32_t *output, uint32_t *weight,
    ...
    int ROWS_IN_L2 = min(512 / ROWS_IN_BLOCK, (int) (seq_len / ROWS_IN_BLOCK));
    int COLS_IN_L2 = min(256 / COLS_IN_BLOCK, (int) (input_size_ / COLS_IN_BLOCK));
    int W_COL_IN_L2 = min(256 / W_COL_BLOCKS, (int) (output_size_ / W_COL_BLOCKS));
